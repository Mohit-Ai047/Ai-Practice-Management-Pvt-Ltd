            ...
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                >
                    ...
                    <div className="space-y-8 text-[#FEFAE0] leading-relaxed">
                        ...
                        <section>
                            <h3 className="text-2xl font-bold text-[#FEFAE0] mb-4">Hyperlinking to our Content</h3>
                            <p className="opacity-90 mb-4">
                        ...
                        <section>
                            <h3 className="text-2xl font-bold text-[#FEFAE0] mb-4">Content Liability</h3>
                            <p className="opacity-90">
                        ...
                        <section>
                            <h3 className="text-2xl font-bold text-[#FEFAE0] mb-4">Reservation of Rights</h3>
                            <p className="opacity-90">
                        ...
                        <section>
                            <h3 className="text-2xl font-bold text-[#FEFAE0] mb-4">Removal of links from our website</h3>
                            <p className="opacity-90 mb-4">
                        ...
                        <section>
                            <h3 className="text-2xl font-bold text-[#FEFAE0] mb-4">Disclaimer</h3>
                            <p className="opacity-90 mb-4">
