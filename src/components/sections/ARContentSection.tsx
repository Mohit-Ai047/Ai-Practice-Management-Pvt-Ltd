                ...
                <div className="max-w-5xl mx-auto space-y-16">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center gap-6">
                            ...
                            {/* Left Dollar Box */}
                            <div className="bg-[#FEFAE0] rounded-xl overflow-hidden relative h-16 w-16 flex items-center justify-center">

                                <div className="absolute flex flex-col animate-dollar-loop">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-xl md:text-2xl text-[#FEFAE0]/80">
                                    ...
                                    <span className="text-white font-bold border-b-2 border-white">
                                        AiPM
                                    </span>{" "}
                                    to collect it.
                                </p>
